...
export const CollectablesList: Array<ListType> = [
  ...
  },
  {
    ...
    requirements: [
      ...
      {
        id: "7f60d2af-1cb6-4a98-8e8f-bb81eed0a5b5",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Moore's+Bell+Bearing",
          "Moore's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "888320d9-de75-4f2a-9ddd-3b3ff9eb9ce8",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Ymir's+Bell+Bearing",
          "Ymir's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "e92ef6cc-b11a-47a3-8e02-b176beb57c4e",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Herbalist's+Bell+Bearing",
          "Herbalist's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "c437068b-a5c7-434c-a703-2266a2a9c98d",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Mushroom-Seller's+Bell+Bearing+(1)",
          "Mushroom-Seller's Bell Bearing (1)",
        ),
        isDLC: true,
      },
      {
        id: "831baa72-3111-4b04-a269-38bc55947629",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Mushroom-Seller's+Bell+Bearing+(2)",
          "Mushroom-Seller's Bell Bearing (2)",
        ),
        isDLC: true,
      },
      {
        id: "cfe916c9-709f-4ccf-8a20-7885be1b8914",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Greasemonger's+Bell+Bearing",
          "Greasemonger's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "775d5504-db37-4966-8e14-4bcc70abbe67",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Moldmonger's+Bell+Bearing",
          "Moldmonger's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "bfed1103-6745-460c-b3dd-c09398ad3697",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Igon's+Bell+Bearing",
          "Igon's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "4af4f94f-2e9e-44a9-b827-2264f06d2ca7",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Spellmachinist's+Bell+Bearing",
          "Spellmachinist's Bell Bearing",
        ),
        isDLC: true,
      },
      {
        id: "c7245ea8-8446-4067-bde0-b1c4751f32c9",
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/String-Seller's+Bell+Bearing",
  ...
  },
  {
    ...
    requirements: [
      ...
      },
      {
        ...
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Arsenal+Charm+1",
          "Arsenal Charm +1",
        ),
      },
      {
      ...
      },
      {
        ...
        description: rawHTMLLink(
          "https://eldenring.wiki.fextralife.com/Crimson+Seed+Talisman+1",
